...
module internal ScanInternal =
    ...
    let private preScan
        ...
        fun (processor: DeviceCommandQueue<_>) (inputArray: ClArray<'a>) (totalSum: ClCell<'a>) ->
            let numberOfGroups =
    ...
    let private scan (opAdd: Expr<'a -> 'a -> 'a>) (saveSum: bool) (clContext: ClContext) (workGroupSize: int) =
        ...
        fun (processor: DeviceCommandQueue<_>) (inputArray: ClArray<'a>) (carry: ClArray<'a>) (totalSum: ClCell<'a>) ->
            let numberOfGroups =
                inputArray.Length / valuesPerBlock
                + (if inputArray.Length % valuesPerBlock = 0 then
                       0
