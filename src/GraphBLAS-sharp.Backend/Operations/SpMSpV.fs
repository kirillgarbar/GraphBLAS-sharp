...
module SpMSpV =
    ...
    let private count (clContext: ClContext) workGroupSize =
        ...
        let count =
            <@ fun (ndRange: Range1D) vectorLength (vectorIndices: ClArray<int>) (vectorValues: ClArray<'b>) (vectorMask: ClArray<'d option>) (matrixRowPointers: ClArray<int>) (matrixColumns: ClArray<int>) (result: ClCell<int>) ->
                let gid = ndRange.GlobalID0
                let gStride = ndRange.GlobalWorkSize
